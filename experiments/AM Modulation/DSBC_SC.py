...
class DSBC_SC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "DSBC_SC")
        ...
        labels = ['Modulatad Signal', 'Mesage', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate_audio, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate_audio) if "auto" == "time" else int(0.1), 1) )
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, 5)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.audio_source_0 = audio.source(samp_rate, '', False)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate_audio, analog.GR_COS_WAVE, 1e5, 1, 0, 0)
    ...
    def set_samp_rate_audio(self, samp_rate_audio):
        ...
        self.blocks_throttle2_0.set_sample_rate(self.samp_rate_audio)
...
def main(top_block_cls=DSBC_SC, options=None):
